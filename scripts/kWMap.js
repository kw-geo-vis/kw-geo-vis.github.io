...
var KWMap = {
	...
	displayCredits: function() {
		this.map.fire('modal', {
			template: ['',
				'<div class="intro">',
				'<h2 class="intro__head">Credits</h2>',
				'<hr/>',
				'<h3>Mapping</h3>',
				...
				'<p class="intro__text intro__text--tight">"<a href="https://thenounproject.com/term/upload/23675/">Cloud Upload</a>" icon by WARSLAB from <a href="http://thenounproject.com/">the Noun Project</a></p>',
				'<h3>All other code and design</h3>',
				'<p class="intro__text"><a href="https://uk.linkedin.com/in/andrew-bean-2001a591">Andrew Bean</a></p>',
			].join(''),		
		});
	},
